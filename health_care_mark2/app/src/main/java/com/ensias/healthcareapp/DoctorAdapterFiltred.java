...
public class DoctorAdapterFiltred  extends RecyclerView.Adapter<DoctorAdapterFiltred.DoctoreHolder2> implements Filterable {
    ...
    private void openPage(Context wf){
      ...
      //aryan  Intent i = new Intent(wf, MyCalendarDoctorActivity.class); //Changed the TestActivity to MyCalenderDoctorActivity
        //Intent i = new Intent(wf, fragment_booking_step_one.class);
        wf.startActivity(i);
    }
}
